...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("breeze.hsluv")
    if color ~= "NONE" then
...
---@param groups breeze.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/breeze-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, breeze.Cache
